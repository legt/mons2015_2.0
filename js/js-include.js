...
// Content variables
var mainTitle = 'HEEFT U AL MET EEN ONAFHANKELIJK HERBALIFE MEMBER GESPROKEN?';
var contentLineOne = 'Geniet van de voordelen van het direct contact met een Onafhankelijk Herbalife Member.';
var contentLineTwo = 'Als u al <span>in contact bent met een Onafhankelijk Herbalife Member</span>, zorg ervoor dat u in contact blijft om te blijven profiteren van persoonlijke ondersteuning.'; // Anything you want to highlight, wrap it in a <span></span> tag
var contentSmallPrint = 'Herbalife producten worden exclusief verkocht door onze Onafhankelijk Herbalife Members. Deze website wordt beheerd door een Onafhankelijk Herbalife Member en niet door Herbalife Europe Ltd. De officiële Herbalife website kunt u vinden op <a href="http://herbalife.be" target="_blank">herbalife.be</a>'; // Links must be wrapped in and <a href=""></a> tag
